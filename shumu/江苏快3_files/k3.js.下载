...
var ethdxZhushu;
$(function(){
	var str = `<div id="popup_box" style="width: 100%;height: 100vh;display:none; z-index: 10000; margin: 0px;padding: 0px;top: 0px;left: 0px; position: fixed; background-color: rgba(55,55,55,.6);">
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
		if(data.sign==true){
			...
			for(var o in lotlist){
				...
				html += '<tr style="color:#caebda;"><td class="fz13">'+openinfo.expect+'</td><td class="fb">'+openinfo.opencode+'</td><td class="fb">'+sum+'</td><td>'+smallbig+'&nbsp;|&nbsp;'+oddeven+'</td></tr>';
